...
const foodDetails = {
  ...
  'hawawshi': {
    name: 'الحواوشي البلدي المصري بالفرن',
    slang: 'الحواوشي',
    desc: 'لحم مفروم متبل بسخاء بالبصل والفلفل الحار والبهارات الخاصة، يحشى داخل أرغفة الخبز البلدي المصري ثم يدهن بالسمن ويشوى على الفحم أو يخبز في الفرن ليصبح مقرمشاً من الخارج ونائراً من الداخل.',
    places: 'حواوشي الربيع (إمبابة)، حواوشي الرفاعي، مطعم البرنس.',
    priceEgp: '50 - 100 جنيه مصري',
    priceSar: '5 - 9 ريال سعودي',
    photo: '',
    googleLink: 'https://www.google.com/search?q=Egyptian+Hawawshi&tbm=isch'
  },
  'fattah': {
    name: 'الفتة المصرية بالخل والثوم واللحم',
    slang: 'الفتة المصرية',
    desc: 'طبق الاحتفالات والمناسبات القومي بمصر. يتكون من طبقات من الخبز البلدي المحمص في السمن البلدي، يغطى بالأرز الأبيض ويسقى بمرقة اللحم الغنية، ثم يصب فوقه صلصة الطماطم الغنية بالخل والثوم المقلي ويقدم مع قطع اللحم المحمر.',
    places: 'مطعم أبو السيد (الزمالك)، مطعم صبحي كابر، مطعم قصر الكبابجي.',
    priceEgp: '180 - 320 جنيه مصري',
    priceSar: '15 - 28 ريال سعودي',
    photo: '',
    googleLink: 'https://www.google.com/search?q=Egyptian+Fattah&tbm=isch'
  },
  'sausage': {
    name: 'السجق الإسكندراني الحار والتوابل',
    slang: 'السجق الإسكندراني',
    desc: 'سجق بلدي مصري متبل بالثوم والتوابل، يقطع ويطهى على الجريل أو في المقلاة مع البصل الطازج والفلفل الأخضر الحار والطماطم المفرومة والثوم، يقدم كوجبة خفيفة مع الخبز الفينو أو كطبق رئيسي.',
    places: 'كبدة البرنس (إمبابة)، مطعم الفلاح، عربات السجق والكبده الشعبية.',
    priceEgp: '60 - 120 جنيه مصري',
    priceSar: '6 - 11 ريال سعودي',
    photo: '',
    googleLink: 'https://www.google.com/search?q=Alexandrian+Sausage+Egypt&tbm=isch'
  },
  'fish': {
  ...
  const categories = [
    ...
    },
    {
      ...
      items: [
        ...
        { key: 'hawawshi', name: 'الحواوشي البلدي المصري بالفرن', slang: 'الحواوشي', desc: 'لحم مفروم متبل بالبهارات محشو داخل الخبز البلدي ومخبوز بالفرن.' },
        { key: 'fattah', name: 'الفتة المصرية بالخل والثوم واللحم', slang: 'الفتة المصرية', desc: 'خبز محمص وأرز مصري بصلصة الخل والثوم واللحم المفروم والمحمر.' }
      ]
    },
    {
      title: 'وجبات ومأكولات خفيفة وسريعة (جانبية)',
      items: [
        { key: 'sausage', name: 'السجق الإسكندراني الحار والتوابل', slang: 'السجق الإسكندراني', desc: 'سجق مطبوخ مع الطماطم والفلفل الأخضر الحار والبصل والثوم.' }
      ]
    },
    {
